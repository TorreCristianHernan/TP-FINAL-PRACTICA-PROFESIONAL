...
public class DynamicQueryService {
    ...
    public Map<String, Object> getTableData(TableRequestDTO request) {
        ...
        Long total = tpl.queryForObject(countQ, params.toArray(), Long.class);
    ...
    public List<String> getAllTables(String db) {
        ...
        try {
            DatabaseMetaData md = tpl.getDataSource().getConnection().getMetaData();
            // PASO CLAVE: le paso 'db' como primer parámetro
